...
@section('content')
    <div class="pt-12 lg:pt-0 px-4 bg-[#1650d0] rounded-b-3xl pb-36 dark:bg-[#051139]">
        <h1 class="text-lg font-thin text-white  pt-12 lg:pl-4 uppercase">Teachers</h1>
        <div class="mt-6 flex items-center gap-2 justify-end">
            ...
            <a href="{{ route('teacher.index', 'Approved') }}"
            ...
            <a href="{{ route('teacher.index', 'Rejected') }}"
            ...
            <a href="{{ route('teacher.create', 'Pending') }}"
            ...
            <tbody>
                @foreach ($teachers as $teacher)
                    <tr class="border border-gray-300">
                        ...
                        <td class="py-2  border border-gray-300 px-2">{{ $teacher->status }}</td>

                        <td class="py-2  border border-gray-300 px-2">
                            <div class="flex items-center justify-center gap-1">
                                <div>
                                    <button onclick="showChangeStatus('{{ $teacher->id }}','Pending')" title="Pending"
                                ...
                                <div>
                                    <button onclick="showChangeStatus('{{ $teacher->id }}','Rejected')" title="Rejected"
                                ...
                                <div>
                                    <button onclick="showChangeStatus('{{ $teacher->id }}','Approved')" title="Approved"
...
@section('js')
    ...
    {{-- Show Status Modal --}}
    <script>
        function showChangeStatus($id, $teacherstatus) {
            $('#statusmodal').removeClass('hidden');
            document.getElementById('status').value = $teacherstatus;
            document.getElementById('statusid').value = $id;
            $('#warningtext').text('Mark as ' + $teacherstatus + ' ? ');
        }
