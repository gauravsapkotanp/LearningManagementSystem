            ...
            <thead>
                <tr class="border border-gray-300">
                    <td class="font-bold py-2 border border-gray-300 px-2">
                        S.N.</td>
                    <td class="font-extrabold py-2 border border-gray-300 px-2">Date</td>
                    <td class="font-extrabold py-2 border border-gray-300 px-2">Title</td>
                    <td class="font-extrabold py-2 border border-gray-300 px-2">File</td>
            ...
            <tbody>
                @foreach ($notices as $notice)
                    <tr class="border border-gray-300">
                        ...
                        <td class="py-2  border border-gray-300 px-2">{{ $notice->date }}</td>
                        <td class="py-2  border border-gray-300 px-2">{{ $notice->title }}</td>
                        <td class="py-2  border border-gray-300 px-2">
                            <a href="{{ asset('img/files/' . $notice->file) }}">
                                <img class="w-14 mx-auto" src="{{ asset('img/files/' . $notice->file) }}" alt="">
                            </a>
                        </td>
                        <td class="py-2  border border-gray-300 px-2">{{ $notice->status }}</td>

                        <td class="py-2  border border-gray-300 px-2">
                            <div class="flex items-center justify-center gap-1">
                                <div>
                                    <button>
                                        <a href="{{ route('notice.edit', $notice->id) }}" title="Edit"
