...
@section('content')
    <div class="pt-12 lg:pt-0 px-4 bg-[#1650d0] pb-36 dark:bg-[#051139]">
        <h1 class="text-lg font-thin text-white pt-12 lg:pl-4 uppercase">Add Notice</h1>
    </div>
    ...
    <div class="pb-8 p-4 bg-white dark:bg-[#111c44] rounded-xl shadow-md -mt-28 mx-3 lg:mx-5 ">
        <form method="POST" action="{{ route('notice.store') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <p><input type="file" class="form-control" accept="image/*" name="file" id="file"
            ...
            <div class="mt-4 flex justify-center">
                <button type="submit" name="submit"
                    class="bg-blue-700 hover:bg-transparent border-2 hover:border-blue-700 hover:text-blue-700 duration-1000 py-2.5 mx-2 w-24 text-xs  font-bold text-white shadow-md shadow-indigo-200 hover:shadow-sm dark:shadow-gray-600 rounded-full cursor-pointer">Submit</button>
